      ...
      <div className="flex justify-between items-center h-16 bg-yellow-500 text-white relative mt-10 pt-40 pb-40 ">
        <div className="w-full flex text-left">
          ...
          <div className="w-2/6 mr-20">
            <div className="text-4xl font-bold mb-5">ILUNI KMB</div>
          ...
          <div className="w-2/6">
            <div className="text-4xl font-bold mb-5">Contact Person</div>
            <div className="w-3/4 text-lg">0821664555</div>
            <div className="w-3/4 text-lg">Admin@gmail.com</div>
          </div>
          <div className="w-1/6"></div>
        </div>
      </div>
